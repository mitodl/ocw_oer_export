...
from utilities.markdown_to_text import markdown_to_text
from utilities.markdown_to_text2 import unmark
load_dotenv()
...
def main():
    ...
    final_df = pd.DataFrame(processed_data, columns=["CR_TITLE", "CR_URL", "CR_MATERIAL_TYPE", "CR_Media_Formats", "CR_ABSTRACT", "CR_LANGUAGE", "CR_COU_TITLE", "CR_PRIMARY_USER", "CR_SUBJECT"])
